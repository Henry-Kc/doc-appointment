...
import { doctorAppointmentsGrid } from '../../data/dummy';
import { Header } from '../../components/AdminDashboardComponent';

const DoctorAppointments = ({category, title}) => {
    ...
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
      ...
      >
        <ColumnsDirective>
          ...
          {doctorAppointmentsGrid.map((item, index) => <ColumnDirective key={index} {...item} />)}
        </ColumnsDirective>
